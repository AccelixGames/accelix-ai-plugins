...
install_plugin "gemini-agent"       "accelix-ai-plugins" "팀"
install_plugin "research"           "accelix-ai-plugins" "팀"
...
install_npm_global "Gemini CLI"                 "@google/gemini-cli"    "command -v gemini"
...
echo ""
echo "다음 단계:"
echo "  1. Gemini API key 설정 (이미지 생성 + Gemini 서브에이전트 사용 시):"
echo "     GEMINI_API_KEY 환경변수 등록 (https://aistudio.google.com/apikey)"
